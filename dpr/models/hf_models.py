...
from .batchensemble import BatchEnsemble
from .reader import Reader

logger = logging.getLogger(__name__)

def get_bert_batchensemble_components(args, inference_only: bool = False, **kwargs):
    batchensemble = BatchEnsemble( 
        vector_size=args.vector_size,
        ensemble_size=args.ensemble_size,
        device=args.device,
        anchor_prior=bool(args.ensemble_prior),
    )
    ...
    return batchensemble, optimizer
...
def get_bert_biencoder_components(args, inference_only: bool = False, **kwargs):
    ...
    biencoder = BiEncoder(
        ...
        ensemble_size=args.ensemble_size,
        ensemble_sample_size=args.ensemble_sample_size,
        device=args.device,
    )
