...
def init_batchensemble(args, **kwargs):
    if importlib.util.find_spec("transformers") is None:
        raise RuntimeError('Please install transformers lib')
    from .hf_models import get_bert_batchensemble_components
    return get_bert_batchensemble_components(args, **kwargs)
...
BATCHENSEMBLE_INITIALIZERS = {
    'hf_bert': init_batchensemble,
}
...
def init_batchensemble_components(encoder_type: str, args, **kwargs):
    return init_comp(BATCHENSEMBLE_INITIALIZERS, encoder_type, args, **kwargs)
